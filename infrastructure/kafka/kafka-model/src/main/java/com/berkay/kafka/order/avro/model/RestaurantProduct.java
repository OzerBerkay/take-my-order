...
public class RestaurantProduct extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.berkay.kafka.order.avro.model.RestaurantProduct.Builder newBuilder() {
    return new com.berkay.kafka.order.avro.model.RestaurantProduct.Builder();
  }
   ...
   * @return A new RestaurantProduct RecordBuilder
   */
  public static com.berkay.kafka.order.avro.model.RestaurantProduct.Builder newBuilder(com.berkay.kafka.order.avro.model.RestaurantProduct.Builder other) {
    if (other == null) {
      return new com.berkay.kafka.order.avro.model.RestaurantProduct.Builder();
    } else {
      return new com.berkay.kafka.order.avro.model.RestaurantProduct.Builder(other);
    }
  }
   ...
   * @return A new RestaurantProduct RecordBuilder
   */
  public static com.berkay.kafka.order.avro.model.RestaurantProduct.Builder newBuilder(com.berkay.kafka.order.avro.model.RestaurantProduct other) {
    if (other == null) {
      return new com.berkay.kafka.order.avro.model.RestaurantProduct.Builder();
    } else {
      return new com.berkay.kafka.order.avro.model.RestaurantProduct.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantProduct>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.berkay.kafka.order.avro.model.RestaurantProduct.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.berkay.kafka.order.avro.model.RestaurantProduct other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.productId)) {
        this.productId = data().deepCopy(fields()[0].schema(), other.productId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkay.kafka.order.avro.model.RestaurantProduct.Builder setProductId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkay.kafka.order.avro.model.RestaurantProduct.Builder clearProductId() {
      productId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkay.kafka.order.avro.model.RestaurantProduct.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkay.kafka.order.avro.model.RestaurantProduct.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkay.kafka.order.avro.model.RestaurantProduct.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkay.kafka.order.avro.model.RestaurantProduct.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkay.kafka.order.avro.model.RestaurantProduct.Builder setAvailable(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkay.kafka.order.avro.model.RestaurantProduct.Builder clearAvailable() {
