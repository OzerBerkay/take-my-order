...
public class RestaurantWallet extends Wallet {

    public RestaurantWallet(WalletId walletId, UUID ownerId, Money balance) {
        super(walletId, ownerId, OwnerType.RESTAURANT, balance);
    }
    ...
    public void subtractBalance(Money amount) {
        ...
        if (getBalance().isGreaterThan(amount) || getBalance().equals(amount)) {
            ...
            throw new PaymentDomainException("Restaurant does not have enough balance for this transaction!");
        }
    }
}
