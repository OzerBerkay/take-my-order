...
public class RoleRepositoryImpl implements RoleRepository {
    ...
    @Override
    @Transactional
    public void updatePermission(com.berkay.payment.service.domain.dto.message.PermissionEventPayload payload) {
        log.info("Updating permission id: {}", payload.getPermission().getId());
        com.berkay.payment.service.domain.dto.message.PermissionPayload permissionPayload = payload.getPermission();
