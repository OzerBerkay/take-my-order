...
import com.berkay.restaurant.service.application.job.RoleInitialSyncJob;
...
public class RoleManagementController {
    ...
    @PreAuthorize("@restaurantAuthService.hasPermission(authentication, 'restaurant_service_can_sync_roles')")
