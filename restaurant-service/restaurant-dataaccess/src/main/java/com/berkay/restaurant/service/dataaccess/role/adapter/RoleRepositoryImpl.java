...
public class RoleRepositoryImpl implements RoleRepository {
    ...
    public void save(RoleEventPayload payload) {
        ...
        if (payload.getPermissions() != null) {
            List<com.berkay.restaurant.service.domain.dto.message.PermissionPayload> filteredPermissions = payload.getPermissions().stream()
                    .filter(p -> "RESTAURANT".equalsIgnoreCase(p.getDomain()))
                    .toList();
